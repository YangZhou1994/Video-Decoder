...
#include <jni.h>
/* Header for class org_cripac_isee_vpe_util_VideoDecoder */

#ifndef _Included_org_cripac_isee_vpe_util_VideoDecoder
#define _Included_org_cripac_isee_vpe_util_VideoDecoder
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_cripac_isee_vpe_util_VideoDecoder
 * Method:    initialize
 * Signature: ([B)J
 */
 ...
 * Signature: (J)V
 */
JNIEXPORT jint JNICALL Java_org_cripac_isee_vpe_util_VideoDecoder_skipFrame
